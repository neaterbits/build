...
import com.neaterbits.build.buildsystem.maven.components.plexus.elements.PlexusComponent;
import com.neaterbits.build.buildsystem.maven.components.plexus.elements.PlexusComponentSet;
import com.neaterbits.build.buildsystem.maven.components.plexus.elements.PlexusRequirement;
import com.neaterbits.build.buildsystem.maven.components.plexus.parse.common.RoleHintSetter;
import com.neaterbits.build.buildsystem.maven.components.plexus.parse.common.RoleSetter;
