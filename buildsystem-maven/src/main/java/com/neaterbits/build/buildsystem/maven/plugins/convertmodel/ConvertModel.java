...
import com.neaterbits.build.buildsystem.maven.elements.MavenBaseBuild;
...
import com.neaterbits.build.buildsystem.maven.elements.MavenFiles;
...
public class ConvertModel {
    ...
    private static Model convertModel(com.neaterbits.build.buildsystem.maven.elements.MavenProject project) {
